...
import calculus.univariate.models.functions.combinations.ExponentialFunction;
...
public class ExponentialFunctionTests {
    ...
    public void builder_tests() {
        ...
        assertEquals(0.0, expFunc.getDomain().get(0).getLowerBound(), 0);
    ...
    public void derivative_test() {
        ...
        assertEquals("f'(x) = ( 1 )( 0.6931 )( 4x + 1 )( 2.0^(2x² + x) )", derivative.toString());
    }
