...
@Getter
public class QuadraticInequality implements Inequality {
    ...
    public QuadraticInequality(final InequalityType type, final PolynomialFunction leftSide, final PolynomialFunction rightSide) {
    ...
    public void solve() {
        ...
        this.solution = criticalRanges.stream().filter(
                range ->  {
                    ...
                    if ( reducedLeftSide.evaluate(testValue) < 0) {
                        return this.type == InequalityType.LESS_THAN;
                    } else {
                        return this.type == InequalityType.GREATER_THAN;
                    }
                }
